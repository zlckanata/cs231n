...
class TwoLayerNet(object):
  ...
  def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
    ...
    #zlc:it is essential to set the first dim 1, to fit the shape with db1 and db2 after.
    #or i must change the ways generalizing db1 and db2.
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
...
class FullyConnectedNet(object):
  ...
  def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
    ...
    for i in xrange(self.num_layers):
      ...
      if self.use_batchnorm and i < len(hidden_dims):#the last layer don't need batch norm
  ...
  def loss(self, X, y=None):
    ...
    scores, cache_final = affine_forward(out[nl-1], W, b)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    dout, dbn, dh = {}, {}, {}
    dout[nl-1], grads['W'+str(nl)], grads['b'+str(nl)] = affine_backward(dloss, cache_final)
